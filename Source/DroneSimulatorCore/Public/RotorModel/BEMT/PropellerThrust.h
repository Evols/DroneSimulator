...
struct DRONESIMULATORCORE_API FPropellerSimInfo
{
...
namespace simulation_bemt
{
	 ...
	 */
	TTuple<FPropellerSimInfo, FDebugLog> DRONESIMULATORCORE_API simulate_propeller_thrust(FSubstepBody* substep_body, double throttle,
