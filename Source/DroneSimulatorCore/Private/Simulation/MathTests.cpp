...
BEGIN_DEFINE_SPEC(FMathSpec, "DroneSimulator.Math", EAutomationTestFlags_ApplicationContextMask | EAutomationTestFlags::EngineFilter)
END_DEFINE_SPEC(FMathSpec)
