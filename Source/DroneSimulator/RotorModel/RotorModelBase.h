...
struct FRotorSimulationResult
{
    ...
    FRotorSimulationResult(const FThrustSimValue& in_value, const TOptional<FThrustSimAdditionalData>& in_additional_data, const FDebugLog& in_debug_log)
        : value(in_value)
        , additional_data(in_additional_data)
...
class DRONESIMULATOR_API URotorModelBase : public UObject
{
    GENERATED_BODY()
